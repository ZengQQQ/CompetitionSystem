                            ...
                            <div class="container" ng-app="winnieApp" ng-controller="winnieCtrl">
                                ...
                                <div class="box">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <c:forEach items="${teammates}" var="teammate">
                                                <tr ng-repeat="data in information | filter:search">
                                                    <td>${teammate.getStudent_ID()}</td>
                                                    <td>${teammate.getStudent_Name()}</td>
                                                    <td>${teammate.getMajor()}</td>
                                                    <td>${teammate.getTel()}</td>
                                                    <td>${teammate.getStrong_point()}</td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
