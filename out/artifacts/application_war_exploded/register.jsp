                ...
                <div class="form-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">
						...
						<div class="contact-form">
							<form method="post" action="http://localhost:8080/_war_exploded/register_program" id="contact-form">
                                <div class="form-group">
                                    <input type="text" name="Student_ID" maxlength="10" placeholder="Student_ID" required="">
                                </div>
								<div class="form-group">
                                    <input type="text" name="phone" maxlength="15" placeholder="phone" required="">
                                </div>
		                        <div class="form-group">
                                    <input type="text" name="UName" maxlength="8" placeholder="Name" required="">
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="text" name="pwd2" placeholder="Confirm your password" required="">
                                </div>
                                <div class="form-group text-right">
                                    <button class="theme-btn btn-style-two">
                                        <span class="btn-box"><span class="btn-txt">signup</span><i class="btn-arrow fal fa-arrow-right"></i></span>
                                    </button>
                                </div>
